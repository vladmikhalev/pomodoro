    ...
    <div className={styles.statist}>
      ...
      <div className={styles.card}>
        <div className={styles.cont}>
          ...
          <span className={styles.percent}>{dailyStatistics ? dailyStatistics.pauseTimeTotal : 0}м</span>
        </div>
        <svg width="115" height="115" viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={styles.card}>
        <div className={styles.cont}>
          ...
          <span className={styles.percent}>{dailyStatistics ? dailyStatistics.stops : 0}</span>
        </div>
        <svg width="115" height="115" viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg">
