  ...
  return (
		<header className={styles.header}>
			<div className={styles.container}>
				<Link to={'/timer'} className={styles.logoBtn}>
					<img className={styles.logoIcon} src={`${process.env.PUBLIC_URL}/assets/images/tomato-logo.svg`} alt="logo pomodoro" />
					<span className={styles.logoText}>pomodoro_box</span>
				</Link>
				<Link to={'/statistics'} className={styles.statisticsBtn}>
